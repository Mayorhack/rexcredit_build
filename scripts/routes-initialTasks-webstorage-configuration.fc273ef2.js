(function (mifosX) {
  var defineRoutes = function ($routeProvider, $locationProvider) {
    $routeProvider
      ...
      .when(
        "/editinterestratecharts/:chartId/:productId/:productName/:productType",
        {
      ...
      .when("/teller_posting", {
        templateUrl: "views/accounting/teller_posting.html",
      })
      .when("/create_teller", {
        templateUrl: "views/accounting/createteller.html",
      })
      ...
      .when(
        "/editcalendarbasedonmeetingdates/:entityType/:groupOrCenterId/:calendarId",
        {
      ...
      .when(
        "/editgsimaccount/:parentGSIMId/:gsimChildAccountId/:groupId/:gsimAccountNumber",
        {
      ...
      .when(
        "/viewguarantortransactions/:savingsId/:fundingId/:fromPath/:fromPathId",
        {
          templateUrl: "views/savings/list_onhold_transactions.html",
        }
      )
      ...
      .when(
        "/shareaccount/:accountId/purchasedshares/:purchasedSharesId/:action",
        {
          templateUrl: "views/shares/shareaccountactions.html",
        }
      )
      ...
      .when("/entitydatatablechecks", {
        templateUrl:
          "views/organization/entitydatatablechecks/entitydatatablechecks.html",
      })
      .when("/notifications", {
      ...
      .when("/bulkimportloanaccounts", {
        templateUrl:
          "views/organization/bulkimport/bulkimportloanaccounts.html",
      })
      ...
      .when("/bulkimportsavingsaccounts", {
        templateUrl:
          "views/organization/bulkimport/bulkimportsavingsaccounts.html",
      })
      .when("/bulkimportsavingsaccountstransactions", {
        templateUrl:
          "views/organization/bulkimport/bulkimportsavingsaccountstransactions.html",
      })
      .when("/bulkimportrecurringdeposits", {
        templateUrl:
          "views/organization/bulkimport/bulkimportrecurringdeposits.html",
      })
      .when("/bulkimportrecurringdepositstransactions", {
        templateUrl:
          "views/organization/bulkimport/bulkimportrecurringdepositstransactions.html",
      })
      ...
      .when("/bulkimportfixeddepositaccounts", {
        templateUrl:
          "views/organization/bulkimport/bulkimportfixeddepositaccounts.html",
      })
      .when("/bulkimportfixeddeposittransactions", {
        templateUrl:
          "views/organization/bulkimport/bulkimportfixeddeposittransactions.html",
      })
      .when("/bulkimportcoa", {
      ...
      .when("/bulkimportjournalentries", {
        templateUrl:
          "views/organization/bulkimport/bulkimportjournalentries.html",
      })
      ...
      .when("/externalservicesCB/CreditBureau/newconfiguration/", {
        templateUrl:
          "views/administration/addNewCreditBureauConfiguration.html",
      })
      .when(
        "/externalservicesCB/CreditBureau/editconfiguration/:creditbureauId",
        {
          templateUrl:
            "views/administration/EditCreditBureauConfiguration.html",
        }
      )
...
;(function (mifosX) {
  var defineHeaders = function (
    ...
    var baseApiUrl = "https://mifos-backend.slsbank.com";
    var host = "";
    var portNumber = "";
